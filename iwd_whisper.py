...
# === SETUP ===
FILE_ROOT = r"C:\Users\TThiele\Documents\Whisper\Data"
...
whisper.DecodingOptions(language="de")
...
for key, value in folders.items():
  folders[key] = os.path.join(FILE_ROOT, value)
  os.makedirs(folders[key], exist_ok=True)


# === TRANSCRIBE ===
audio_folder, processed_folder, text_file_folder = folders["raw"], folders["processed"], folders["transcribed"]
...
for i, file in enumerate(audio_files):
  ...
  for start, end in pauses: # For each segment
    ...
    temp_file = os.path.join(FILE_ROOT, "temp.wav")
